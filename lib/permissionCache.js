...
import { createManagedInterval } from './processManager';
...
// Start automatic cleanup (managed interval - cleans up on process exit and hot reload)
createManagedInterval(cleanupExpiredEntries, CLEANUP_INTERVAL);
