...
export function registerCleanup(callback) {
  ...
  if (!cleanupHandlersRegistered) {
    ...
    try {
      ...
      console.warn('Process listeners could not be registered (likely running in a serverless/edge environment).');
    }

    // Note: module.hot.dispose disabled to prevent infinite refresh loops
