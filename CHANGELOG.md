...
## [3.6.1](https://github.com/adrianlarsen102/EVU-WEB/compare/v3.6.0...v3.6.1) (2026-09-07)
...
* add secure setup API endpoint and reusable rate limiting middleware ([3be2dc8](https://github.com/adrianlarsen102/EVU-WEB/commit/3be2dc8ee5cf1a1c3572332946416bacb7ac5ddb))
...
* disable auto-push in release-it to support protected branches in CI ([c3a40d9](https://github.com/adrianlarsen102/EVU-WEB/commit/c3a40d9a5f80601febed840dab58466d74a97701))
...
* add script to populate database with demo user roles, site content, and forum data ([134438b](https://github.com/adrianlarsen102/EVU-WEB/commit/134438b8bb0ae142b2a54d4539e4f9e0718e79d0))
...
* implement database utilities and setup page for admin authentication and session management ([ba81a78](https://github.com/adrianlarsen102/EVU-WEB/commit/ba81a7851b302c2979aa07f7f443a0418aef4b64))
...
* comprehensive performance and feature improvements (v3.2.3) ([5232cdf](https://github.com/adrianlarsen102/EVU-WEB/commit/5232cdf55d6e188568d0b42b5f6ddc3add7fff0f))
...
* fix LCP and CLS, update dependencies, migrate to Turbopack ([be1d7e9](https://github.com/adrianlarsen102/EVU-WEB/commit/be1d7e9682772c692b1b53675bd7ec76e0aca877))
